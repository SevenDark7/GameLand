    ...
    <section class="d-flex flex-column bg-dark" style="flex-basis: 40%">
        ...
        <ul class="list-group list-unstyled" style="overflow-y: auto">
            <li class="list-group-item bg-dark border-white rounded-0 border-top-0 border-left-0">
                <form action="/admin/articles/register" method="post">
                    @csrf
                    <legend class="text-info">Insert Game</legend>
                    <table class="table table-dark table-sm">
                        <tbody>
                            <tr>
                                <td><label for="name" class="text-light">Game Name</label></td>
                                <td><input type="text" name="name" class="form-control" autocomplete="off" placeholder="Enter The Name Of The Game"></td>
                            </tr>
                            <tr>
                                <td><label for="platform" class="text-light">Game Platform</label></td>
                                <td><input type="text" name="platform" class="form-control" autocomplete="off" placeholder="Enter The Game Platform"></td>
                            </tr>
                            <tr>
                                <td><label for="release" class="text-light">Game Release</label></td>
                                <td><input type="date" name="release" class="form-control" autocomplete="off" placeholder="Enter The Game Release"></td>
                            </tr>
                            <tr>
                                <td><label for="publish" class="text-light">Game Publisher</label></td>
                                <td><input type="text" name="publish" class="form-control" autocomplete="off" placeholder="Enter The Game Publisher"></td>
                            </tr>
                            <tr>
                                <td><label for="genre" class="text-light">Game Genre</label></td>
                                <td><input type="text" name="genre" class="form-control" autocomplete="off" placeholder="Specify The Genre Of The Game"></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <li class="list-group-item bg-dark border-white rounded-0 border-left-0">
                <form href="/admin/articles/delete" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="delete" class="form-control" autocomplete="off" placeholder="Enter The Name Of The Game To Delete">
                    </div>
                    <div class="d-flex justify-content-around">
