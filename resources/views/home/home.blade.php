...
@section('content')
    <article class="row justify-content-center align-items-center text-light descrip">
        <div class="col-12 col-md-5"><img src="/images/homeFlatImage.png" alt="GameShop"></div>
        <div class="col-12 col-xl-7 home-descrip">روزانه اخبار گسترده ای در زمینه صنعت گیم و بازی های متنوعی برای انواع کنسول های بازی از
